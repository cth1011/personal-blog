...
![COVID-19 Japan Prefectures](./covid-japan.gif)


Using d3.js, I visualized the trend of daily cases and tests added. The case breakdown wasalso visualized by <Text color='red'>Severe</Text>, <Text color='orange'>Active</Text>, <Text color='green'>Recovered</Text>, and <Text color='grey'>Death</Text> through a stacked bar chart. I love the animations when hovering over from one prefecture to another. 
